...
-- ====================HB Cityview==========================================
  ...
  function HB_OnCityviewEnabled()
    --print("OPEN CITY OVERVIEW PANEL");
    OnShowOverviewPanel(true)
  end

  function HB_OnCityviewDisabled()
    --print("CLOSE CITY OVERVIEW PANEL");
    Close();
  end

  LuaEvents.HB_CityPanelOverview_CityviewEnable.Add( HB_OnCityviewEnabled);
  LuaEvents.HB_CityPanelOverview_CityviewDisable.Add( HB_OnCityviewDisabled);
...
function Initialize()
	...
	Controls.Close:SetHide(true);
	
	LuaEvents.CityPanelOverview_ClosePanel.Add(OnClose);
