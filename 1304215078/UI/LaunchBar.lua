...
-- ===========================================================================
function OnOpenDemos()
	LuaEvents.LaunchBar_OpenDemosScreen();
end

-- ===========================================================================
function OnOpenGlobalDiplo()
	LuaEvents.LaunchBar_OpenGlobalDiploScreen();
end
...
function Initialize()
	...
	-- set the global diplo and demos button images
	local iconName = "ICON_CIVIC_THE_ENLIGHTENMENT";
	local textureOffsetX, textureOffsetY, textureSheet = IconManager:FindIconAtlas(iconName,38);
	if (textureOffsetX ~= nil) then
		Controls.DemographicsImage:SetTexture( textureOffsetX, textureOffsetY, textureSheet );
	end

	iconName = "ICON_TECH_WRITING";
	textureOffsetX, textureOffsetY, textureSheet = IconManager:FindIconAtlas(iconName,30);
	if (textureOffsetX ~= nil) then
		Controls.GlobalDiploImage:SetTexture( textureOffsetX, textureOffsetY, textureSheet );
	end

	iconName = "ICON_CIVIC_SOCIAL_MEDIA";
	textureOffsetX, textureOffsetY, textureSheet = IconManager:FindIconAtlas(iconName,38);
	if (textureOffsetX ~= nil) then
	...
	Controls.DemographicsButton:RegisterCallback(Mouse.eLClick, OnOpenDemos);
	Controls.DemographicsButton:RegisterCallback( Mouse.eMouseEnter, PlayMouseoverSound);

	Controls.GlobalDiploButton:RegisterCallback(Mouse.eLClick, OnOpenGlobalDiplo);
	Controls.GlobalDiploButton:RegisterCallback( Mouse.eMouseEnter, PlayMouseoverSound);

	Controls.ReportsButton:RegisterCallback(Mouse.eLClick, OnToggleReportsScreen);
	Controls.ReportsButton:RegisterCallback( Mouse.eMouseEnter, PlayMouseoverSound);
