...
function DisplayDemos()
	...
	Controls.BestPop:SetText(format_int(Best.Pop));
	...
	Controls.WorstPop:SetText(format_int(Worst.Pop));
	...
	Controls.AvgPop:SetText(format_int(Round((AvgData.Pop/playerCount),0)));
...
function Initialize()
	...
	-- Events
	LuaEvents.LaunchBar_OpenDemosScreen.Add( Open );
	LuaEvents.LaunchBar_CloseDemosScreen.Add( Close );
