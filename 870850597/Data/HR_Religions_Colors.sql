...
VALUES	('COLOR_RELIGION_AMATONGO',		0.894,			0.815,			0.039,		1),		
		...
		('COLOR_RELIGION_BUDDHISM',			1,			0.501,			0,		1),
		('COLOR_RELIGION_B1_MAHAYANA',			0.9,			0.1,			0,		1),
		('COLOR_RELIGION_CHALDAENISM',				0.831,			0.49,			1,		1),
		('COLOR_RELIGION_DRUIDISM',			0.227,			0.65,			0.333,		1),
		('COLOR_RELIGION_HINDUISM',				0.5,			0.5,			1,		1),
		('COLOR_RELIGION_JAINISM',			0.9,			0.45,			0.9,		1),
		('COLOR_RELIGION_JUDAISM',				0.364,			0.529,			1,		1),
		('COLOR_RELIGION_MANICHAEISM',		0.95,			0.85,			0.2,		1),
		('COLOR_RELIGION_PCHAISM',			1,			0.407,			0.309,		1),
		('COLOR_RELIGION_PJELANCA',			0.443,			0.674,			0.454,		1),		
		('COLOR_RELIGION_PUATA_TUPUNA',			0,			0.85,			0.5,		1),		
		...
		('COLOR_RELIGION_C1_ORIENTAL',				0.5,			1,			0.5,		1),
		('COLOR_RELIGION_ORTHODOXY',	0.45,			0.75,			1,		1),
		('COLOR_RELIGION_FORN_SIDR',			1,			1,			0.5,		1),
		('COLOR_RELIGION_CUSTOM_9',				0.2,			0.2,			0.9,		1),		
		...
		('COLOR_RELIGION_SHINTO',				0.85,			0.15,			0.15,		1),
		...
		('COLOR_RELIGION_C3_ANGLICANISM',			0.75,			0.75,			0.75,		1),
		...
		('COLOR_RELIGION_C2_NESTORIANISM',			0.831,			0.686,			0.215,		1),
		('COLOR_RELIGION_PESEDJET',			0.721,			0.525,			0.043,		1),
		('COLOR_RELIGION_E0_PESEDJET',			0.721,			0.525,			0.043,		1),
		...
		('COLOR_RELIGION_BIRD_FIGURE_CULT',		0.588,			0.784,			0.635,		1),
		...
		('COLOR_RELIGION_B2_VAJRAYANA',					0.9,			0.75,			0.2,		1),
		...
		('COLOR_RELIGION_MLAGAN',					1,			0.5,			0.7,		1),
		('COLOR_RELIGION_O1_TANGATA_MANU',				0.004,			0.8,			1,		1),
		...
		('COLOR_RELIGION_X7',					1,			0.407,			0.309,		1),
		('COLOR_RELIGION_X6',					0.88,			0.34,			0.44,		1),
		...
		('COLOR_RELIGION_X0',					0.004,			0.8,			1,		1),--
		...
		('COLOR_RELIGION_A1_INTIISM',					0.85,			0.7,			0.2,		1),
		('COLOR_RELIGION_Q3',					0.65,			0.55,			0.34,		1),
		('COLOR_RELIGION_Q2',					0.981,			0.742,			0.345,		1),
		('COLOR_RELIGION_Q4',					0.15,			0.75,			0.55,		1),
		('COLOR_RELIGION_I4_AHMADI',					0.774,       		0.843,         		0.488,          1),
		('COLOR_RELIGION_FAT_ROOG',					0.85,			0.35,			0.5,		1),
		...
		('COLOR_RELIGION_Q5',					0.639,			0.631,			0.129,		1),	
		('COLOR_RELIGION_CATHOLICISM',			1,			0.407,			0.309,		1),

		--('COLOR_MIDEWIWIN_HR',				0.843,			0.973,			0.008,		1),
		--('COLOR_SAN_HR',					0.952,			0.498,			0.509,		1),
		--('COLOR_BAPTIST_HR',					0.878,			0.69,			1,		1),
		...
		('COLOR_EX_SHINTO_HR',				0.85,			0.15,			0.15,		1),
