...
function CityBanner:UpdateReligion()
	...
	-- Suk Addin
	----------------------------------
	-- if table.count(religionsInCity)  > 0 then
	-- 	local tR_Control = self.m_Instance.ReligionInfo.ReligionInfoContainer
	-- 	LuaEvents.Suk_SetReligionTooltip(tR_Control, pCity)
	-- end
	----------------------------------
	----------------------------------	
