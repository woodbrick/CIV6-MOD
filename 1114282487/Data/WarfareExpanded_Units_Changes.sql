...
UPDATE Units SET Combat = 63, RangedCombat = 77, PromotionClass = 'PROMOTION_CLASS_AUTOMATIC_GUN' WHERE UnitType = 'UNIT_MACHINE_GUN';
UPDATE Units SET PromotionClass = 'PROMOTION_CLASS_AUTOMATIC_GUN', Cost = 320, Combat = 48, RangedCombat = 62, Maintenance = 5, ZoneOfControl = 0 WHERE UnitType = 'UNIT_GATLING_GUN';
